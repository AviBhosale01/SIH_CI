...
def render_sidebar():
    ...
    if user:
        ...
        render_html("<hr style='border-top: 1px solid rgba(75, 85, 99, 0.25); margin: 12px 0;'>", sidebar=True)
        ...
        # Workspace actions
        render_html("<hr style='border-top: 1px solid rgba(75, 85, 99, 0.25); margin: 15px 0;'>", sidebar=True)
    ...
    # 2. PUBLIC / PRE-LOGIN NAVIGATION
        ...
        render_html("<hr style='border-top: 1px solid rgba(0, 229, 255, 0.15); margin: 15px 0;'>", sidebar=True)
        render_html("""
